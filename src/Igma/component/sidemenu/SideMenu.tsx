...
const SideMenu = (props: ISideMenu) => {
	const {showSideMenu, toggleSideMenu, sideMenuWidth, setSideMenuWidth} = props;
	...
	const handleResize = (event: MouseEvent | TouchEvent, direction: Direction, elementRef: HTMLElement, delta: NumberSize) => {
		...
		<>
			...
			>
				<aside className="sideMenuWrap" style={sideMenuWrapStyle}>
					{showSideMenu && (
						<>
							<button className="sideMenuCloser" onClick={toggleSideMenu} style={{background: buttonBackground}}>
